...
@section('content')
  <section class="py-0" id="home">
    <div class="bg-holder d-none d-md-block" style="background-image:url(masyarakat/assets/img/illustrations/hero-section.png);background-position:right bottom;background-size:contain;">
    </div>
    <!--/.bg-holder-->

    <div class="bg-holder d-block d-md-none" style="background-image:url(masyarakat/assets/img/illustrations/hero-bg.png);background-position:right top;background-size:contain;">
    </div>
    <!--/.bg-holder-->
    ...
    <div class="container">
      <div class="row align-items-center min-vh-md-75">
        <div class="col-md-7 col-lg-6 py-6 text-sm-start text-center">
          <h1 class="mt-6 display-4 fw-semi-bold lh-sm fs-4 fs-lg-6 fs-xxl-7 text-warning m-0">Pengaduan Masyarakat, </h1>
          <h2 class="mb-sm-4 display-4 fw-semi-bold lh-sm fs-4 fs-lg-6 fs-xxl-7">Suara anda menentukan masadepan kita!</h2>
          <p class="mb-4 fs-1">Wadah aspirasi masyarakat untuk kemajuan bangsa</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="visi">
    <div class="bg-holder" style="background-image:url(masyarakat/assets/img/illustrations/libraries-bg.png);background-position:left bottom;background-size:contain;">
    </div>
    <!--/.bg-holder-->

    <div class="container">
      <div class="row g-xl-0 align-items-center">
        <div class="col-md-5 col-lg-7 text-xl-center"><img wclass="img-fluid mb-5 mb-md-0" src="masyarakat/assets/img/illustrations/our-libraries.png" width="620" alt="" /></div>
        <div class="col-md-7 col-lg-4 text-center text-md-start offset-lg-1 offset-xxl-0">
          <h1 class="fw-semi-bold text-warning">Visi <span class="text-1100">kami</span></h1>
          <p class="pt-3 lh-lg">Kami memfasilitasi masyarakat sebuah wadah aspirasi online berupa web Femas (pengaduan masyarakat) yang diperuntukan untuk menampung segala laporan,keluhan,pengaduan dan saran dari masyarakat</p>
          <div class="py-3">
            <a class="btn btn-lg btn-primary rounded-pill font-base" href="{{ url('pengaduan')}}">Buat Pengaduan </a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="py-0">
    <div class="bg-holder" style="background-image:url(masyarakat/assets/img/illustrations/footer-bg.png);background-position:center;background-size:cover;">
    </div>
    <!--/.bg-holder-->
